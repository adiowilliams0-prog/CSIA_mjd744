// frontend/src/pages/StaffManagement.js
...
const StaffManagement = () => {
  ...
  const fetchStaffList = async () => {
    try {
      ...
      alert(err.msg || "Failed to fetch staff");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleToggle = async (userId) => {
    try {
      ...
      alert(err.msg || "Failed to toggle status");
    }
  };
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      alert(err.msg || "Error creating staff");
    }
  };
          ...
          <tbody>
            {staff.map(member => (
              <tr key={member.user_id}>
                ...
                <td>
                  <button onClick={() => handleToggle(member.user_id)}>
